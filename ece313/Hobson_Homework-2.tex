...
%If we construct a mutually exclusive set of events:
%
%\[
%\zeta=\{R'A'C', R'AC'\}
%\]
%
%then we can apply the definition of the union of mutually exclusive
%events:
%
%\[
%P\left(\bigcup\limits_{E\in\zeta}E\right)=\sum\limits_{E\in\zeta}P(E)
...
%
%\[
%\bigcup\limits_{E\in\zeta}E=R'C'
%\]
%
%so that we have:
%
%\[
%P(R'C')=P(R'A'C')+P(R'AC')
%\]
%
%We can then look at the value of the expression:
%
%\[
%P(R'C') = 1 - P((R'C')')
%\] \[
...
%\]
%
%From here, we can apply the definition for the union of events to find
%the value of $P(R+C)$:
%
%\[
%P(R+C)=P(R)+P(C)-P(RC)
